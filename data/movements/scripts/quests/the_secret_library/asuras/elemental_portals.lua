...
local entrances = {
	...
	[2] = {position = Position(32857, 32766, 10), fromPos = Position(32856, 32740, 11), toPos = Position(32868, 32752, 11),
	storage = Storage.secretLibrary.Asuras.diamondTimer, exit = Position(32857, 32768, 10),
	toPosition = Position(32881, 32789, 11), bossName = 'The Diamond Blossom', bossPos = Position(32881, 32792, 11)},
	[3] = {position = Position(32817, 32777, 11), fromPos = Position(32875, 32786, 11), toPos = Position(32887, 32798, 11),
	storage = Storage.secretLibrary.Asuras.darkTimer, exit = Position(32817, 32779, 11),
	toPosition = Position(32862, 32743, 11), bossName = 'The Lily of Night', bossPos = Position(32862, 32746, 11)},
	[4] = {position = Position(32854, 32737, 10), fromPos = Position(32856, 32768, 11), toPos = Position(32868, 32780, 11),
	storage = Storage.secretLibrary.Asuras.blazingTimer, exit = Position(32854, 32739, 10),
	toPosition = Position(32862, 32771, 11), bossName = 'The Blazing Rose', bossPos = Position(32862, 32774, 11)},
...
local quest = Storage.secretLibrary.Asuras.Questline
