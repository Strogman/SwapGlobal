...
function getRealDate()
	local month = tonumber(os.sdate("%m", os.time()))
	local day = tonumber(os.sdate("%d", os.time()))
...
function getRealTime()
	local hours = tonumber(os.sdate("%H", os.time()))
	local minutes = tonumber(os.sdate("%M", os.time()))
