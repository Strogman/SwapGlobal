...
local leverInfo = {
	-- nome, storage de time, position da lever, tipo de fileira p teleportar (x ou y), position do boss,
	-- posicao p teleportar os players, fromPos e toPos da sala
	[1] = {bossName = 'Mazzinor', storage = Storage.secretLibrary.Library.mazzinorTime, exit = Position(32616, 32532, 13),
	...
	[2] = {bossName = 'Lokathmor', storage = Storage.secretLibrary.Library.lokathmorTime, exit = Position(32467, 32654, 12),
	...
	[3] = {bossName = 'Ghulosh', storage = Storage.secretLibrary.Library.ghuloshTime, exit = Position(32659, 32713, 13),
	...
	[4] = {bossName = 'Gorzindel', storage = Storage.secretLibrary.Library.gorzindelTime, exit = Position(32660, 32734, 12),
