...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "measurements") and npcHandler.topic[cid] == 1 then
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Measurements ) == 2 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskMeasurements) < os.time() then -- Ainda não se passaram as 20h
			npcHandler:say({"I don't need your help for now. Come back later."}, cid)
			playerTopic[cid] = 1
			npcHandler.topic[cid] = 1
		end
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Measurements) == 2 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskMeasurements) > os.time() then -- Vai fazer a missão após 20h
	...
	if msgcontains(msg, "ordnance") and npcHandler.topic[cid] == 1 then
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Ordnance) == 3 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskOrdnance) < os.time() then -- Ainda não se passaram as 20h
			npcHandler:say({"I don't need your help for now. Come back later."}, cid)
			playerTopic[cid] = 1
			npcHandler.topic[cid] = 1
		end
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Ordnance) == 3 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskOrdnance) > os.time() then -- Vai fazer a missão após 20h
	...
	if msgcontains(msg, "charting") and npcHandler.topic[cid] == 1 then
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Charting) == 2 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskCharting) < os.time() then -- Ainda não se passaram as 20h
			npcHandler:say({"I don't need your help for now. Come back later."}, cid)
			playerTopic[cid] = 1
			npcHandler.topic[cid] = 1
		end
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Charting) == 2 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskCharting) > os.time() then -- Vai fazer a missão após 20h
