...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "cloak") and npcHandler.topic[cid] == 1 then
		...
		and player:getStorageValue(Storage.ThreatenedDreams.Valindara.cloakTime) <= os.time() then
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[cid] == 2 then
		if player:getItemCount(id_feather) >= 100 then
			...
			player:setStorageValue(Storage.ThreatenedDreams.Valindara.cloakTime, os.time() + 24 * 60 * 60)
